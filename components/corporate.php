<div class="modal fade" id="corporateModal" role="dialog">
    <div class="modal-dialog">

        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Corporate Enquiry</h4>
            ...
            <div class="modal-body" style="text-align:left; background-color :#f3f1f1;border: 1px solid darkred">
                <form id="frmCorporate" class="form-horizontal">
                    ...
                    <div class="form-group required-field-block">
                        <div>
                            <textarea class="form-control" rows="5" placeholder="Please tell us about your event" name="message"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row ">
                        <div class="col-md-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="Photo" id="CorporatePhoto" checked>
                                <label class="custom-control-label" for="CorporatePhoto">Photo</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="Video" id="CorporateVideo" checked>
                                <label class="custom-control-label" for="CorporateVideo">Video</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="Drone" id="CorporateDrone">
                                <label class="custom-control-label" for="CorporateDrone">Drone</label>
                            </div>
                        </div>
                    </div>

                    <div id="frmCorporate_Msg" class="col-12 text-center alert alert-success" style="display:none">
